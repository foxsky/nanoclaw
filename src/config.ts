...
export const CONTAINER_TIMEOUT = parseInt(
  process.env.CONTAINER_TIMEOUT || '21600000', // 6 hours
  10,
);
...
export const IDLE_TIMEOUT = parseInt(process.env.IDLE_TIMEOUT || '21600000', 10); // 6 hours — how long to keep container alive after last result
