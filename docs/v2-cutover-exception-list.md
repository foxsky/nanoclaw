...
> - **SETD/thiago-INDEP: 14/40, 4 real_divergence** (turns 3,13,14,26) — UNCHANGED by the fix because they are **ACTION-level** (v2 ran `read`/`api_query`, made no mutation call). Confirmed real, not artifacts. Flip-rate across 3 fresh runs: 13/14/26 diverge 3/3, turn 3 diverges 2/3. **This is the durable SETD blocker.**
