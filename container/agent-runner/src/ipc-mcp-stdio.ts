...
Use available_groups.json to find the JID for a group. The folder name should be lowercase with hyphens (e.g., "family-chat").`,
  {
    ...
    requires_trigger: z.boolean().optional().describe('Whether the group requires a trigger word to activate. Defaults to false for TaskFlow groups, true otherwise.'),
  ...
  async (args) => {
    ...
    const data = {
      ...
      requiresTrigger: args.requires_trigger ?? (args.taskflow_managed ? false : true),
